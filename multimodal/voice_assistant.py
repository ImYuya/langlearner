...
INPUT_CONFIG_PATH = "./multimodal/voice_assistant.yaml"
IMAGE_PATH = "./multimodal/voice_assistant.png"
TEMP_PATH = "./temp.wav"
...
def main():
    ...
    # Clear the event queue before starting the event loop
    pygame.event.clear()
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.locals.QUIT:
                ass.shutdown()
            elif event.type == pygame.KEYDOWN and event.key == push_to_talk_key:
